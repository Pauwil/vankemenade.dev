          ...
          <section class="four columns">
              <div class="panel">
                  ...
                  <ul class="nav-bar vertical">
                      <li><a href="index.php?p=rondleiding.php">Rondleiding</a></li>
                      <li class="active"><a href="index.php?p=vestiging.php">Vestiging</a></li>
                      <li><a href="index.php?p=team.php">Ons Team</a></li>
                  </ul>
